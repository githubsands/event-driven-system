...
HELM_RELEASE_NAME="signing-worker"
HELM_CHART_PATH="/Users/ryanvacek/rust/src/axelar-core/devops/signing-workers"
...
sleep 8
kubectl logs --selector signing-worker=true -n=demo -f --max-log-requests 10
